...
<div class="container my-4">
    ...
    <div class="container my-4">
        ...
        <form action= "{{route('proyectoaapadrinados.store')}}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nombre" placeholder="Nombre del niño">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="fechaNacimiento" placeholder="Ingrese en formato AAAA-MM-DD">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="discapacidad" placeholder="Discapacidad del niño">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="institucionEducacional" placeholder="Institucion a la cual pertenece">
                    </div>
                </div> 
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nivelEducacional" placeholder="Nivel educacional del niño">
                    </div>
                </div> 
